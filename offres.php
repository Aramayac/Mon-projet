...
require_once 'header_offres.php';
                    ...
                    <div class="card shadow-sm border-0 rounded-3">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-3">
                                <a href="offre_emploi.php?id=<?= $offre['id_offre'] ?>" class="btn btn-outline-primary btn-sm">
                                    <i class="bi bi-eye"></i> Voir l’offre
                                </a>
                                <a href="postuler.php?id=<?= $offre['id_offre'] ?>" class="btn btn-success btn-sm">
