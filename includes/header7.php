...
<head>
    ...
    <style>
        ...
        .hero-background {
            background: url('/projet_Rabya/igm/bg15.jpg') no-repeat center center/cover;
            height: 100vh;
            position: relative;
        }
...
<body>
    ...
    <div class="hero-background">
        ...
        <div class="hero-content container">
            <h1 class="fw-bold display-6 mt-4">Recrutez les talents du Mali, bâtissez l'avenir !</h1>
