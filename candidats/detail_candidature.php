    ...
    <div class="card shadow">
        ...
        <div class="card-body">
            ...
            <div class="mb-4">
                ...
                <span class="badge bg-<?= 
                    strtolower($candidature['statut']) === 'acceptée' ? 'success' :
                    (strtolower($candidature['statut']) === 'refusée' ? 'danger' : 'secondary')
                ?> ms-2">
                    <i class="bi <?= 
                        strtolower($candidature['statut']) === 'acceptée' ? 'bi-check-circle-fill' :
                        (strtolower($candidature['statut']) === 'refusée' ? 'bi-x-circle-fill' : 'bi-hourglass-split')
