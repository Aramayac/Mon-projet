...
<head>
    ...
    <style>
        body {
            background: url('/projet_Rabya/igm/image.jpg') no-repeat center center fixed;
...
<div class="container py-5">
    ...
    <div id="profil" class="content-section">
        ...
        <a href="/projet_Rabya/candidats/modifier_profil.php" class="btn btn-sm btn-primary mt-3">
            <i class="bi bi-pencil-square"></i> Modifier mon profil
        </a>
        <?php if (!$profil_complet): ?>
            <a href="/projet_Rabya/candidats/completer_profil.php" class="btn btn-warning mt-2 ms-2">
