...
<nav class="navbar navbar-expand-lg navbar-dark bg-transparent px-4 py-3">
    ...
    <div class="collapse navbar-collapse justify-content-center" id="mainNav">
        <ul class="navbar-nav">
            ...
            <li class="nav-item"><a class="nav-link" href="candidats/tableau_candidat.php">Candidats</a></li>
...
<?php endif; ?>
    ...
    <div class="hero-content container">
      <h1 class="fw-bold display-4">Vous etes au bon endroit , chez Mali job on line</h1>
