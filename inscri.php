...
<body>
    ...
    <div class="container registration-container">
        ...
        <div class="registration-box">
            <h3><a href="inscription_candidat.php">Candidat</a></h3>
                            <img src="igm/p4.png" alt="Candidate">
                        <div class="block-links">
                            <a href="inscription_candidat.php" class="btn btn-primary">Cliquez ici</a>
                        </div>
        </div>
        <!-- Recruteur -->
        <div class="registration-box">
           <h3><a href="inscription_recruteur.php">Recruteur</a></h3>

                <picture>   <img src="igm/p5.png" alt="Recruiter"> </picture> 
                     <div class="block-links">
                            <a href="inscription_recruteur.php" class="btn btn-primary">Cliquez ici</a>
                  </div>
        </div>
    </div>
