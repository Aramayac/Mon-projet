...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $stmt->execute([$email]);
    $recruteur = $stmt->fetch();// Récupère le candidat correspondant à l'email
    if ($recruteur) {
        // Générer un token
        ...
        $lien = "http://localhost/projet_Rabya/recruteurs/reinitialisation_mdp_recruteur.php?token=$token";// Lien de réinitialisation avec le token
        ...
        $message = "⚠️ Cet email n'existe pas.";
    }
}
?>
<!DOCTYPE html>
            ...
            <div class="form-container">
                ...
                <form method="post">
                    ...
                    <div class="d-grid gap-2">
                        ...
                        <a href="/projet_Rabya/authentification/connexion_recruteur.php" class="btn btn-secondary btn-lg w-100">
