...
$recruteur = $_SESSION['utilisateur']; // Récupérer les informations de l'utilisateur connecté via la session
    ...
    <div class="container py-5">
            ...
            <div class="card-body card-infos">
                ...
                <div>
                    ...
                    <div class="text-start mt-3">
                        <a href="/projet_Rabya/recruteurs/modifier_recruteur.php" class="btn btn-outline-primary btn-sm">
        ...
        <div class="card shadow border-0 rounded-4">
            <div class="card-header bg-success text-white rounded-top-4 d-flex justify-content-between align-items-center">
                ...
                <a href="/projet_Rabya/recruteurs/ajouter_offre.php" class="btn btn-light btn-sm" title="Ajouter une offres">
                ...
                <?php if (count($offres) > 0): ?>
                    <?php foreach ($offres as $offre): ?>
                        <div class="border-bottom pb-3 mb-3">
                            <h5 class="text-dark"><i class="bi bi-briefcase-fill me-1 text-primary"></i> <?= htmlspecialchars($offre['titre']) ?></h5>
            ...
            <div class="d-flex justify-content-between mt-4">
                <a href="/projet_Rabya/index.php" class="btn btn-secondary">
