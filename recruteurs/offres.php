...
$sql = "
    SELECT o.id_offre, o.titre, o.description, o.lieu, o.date_publication, o.date_expiration, o.type_contrat, r.nom_entreprise, r.logo, o.secteur
                        ...
                        <div class="card shadow-sm border-0 rounded-3">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center mt-3">
                                    ...
                                    <a href="/projet_Rabya/recruteurs/offre_emploi.php?id=<?= $offre['id_offre'] ?>" class="btn btn-success btn-sm">
