...
<head>
    ...
    <style>
        ...
        .hover-shadow:hover {
            ...
            background-color: rgba(251, 154, 154, 0.1) !important;
        }
    </style>
</head>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-transparent px-4 py-3 fixed-top">
        ...
        <div class="collapse navbar-collapse justify-content-center" id="mainNav">
            <ul class="navbar-nav d-flex gap-4">
                ...
                <!-- Bouton de recherche ajouté ici -->
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center gap-1 px-3 text-white rounded-pill bg-transparent bg-opacity-75 hover-shadow"
                        href="/projet_Rabya/recruteurs/rechercher_candidat.php"
