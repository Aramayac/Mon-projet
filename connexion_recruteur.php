...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($errors)) {
        ...
        if ($recruteur && password_verify($mot_de_passe, $recruteur['mot_de_passe'])) {
            ...
            $redirect = isset($_GET['redirect']) ? $_GET['redirect'] : 'tableau_recruteur.php';
                ...
                <div class="card-body px-5 py-4">
                    ...
                    <form method="post">
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            <a href="inscription_recruteur.php" class="btn btn-secondary">
                        ...
                        <div class="text-center mt-3">
                          <p>Vous n'avez pas de compte ?  <a href="inscription_recruteur.php" class="text-decoration-none text-primary">
                        ...
                        <div class="text-center mt-3">
                            <a href="mdp_oublie_recruteur.php" class="text-decoration-none text-primary">
