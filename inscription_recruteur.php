...
<style>
        body {
            background-image: url('igm/p5.png');
        }
         .container{
            margin-top: -50px;
        }
            ...
            <div class="card shadow-lg rounded-4">
                ...
                <div class="card-body px-5 py-4">
                    ...
                    <form method="post" enctype="multipart/form-data">
                        ...
                        <div>
                            <p class="mt-3 text-center">Déjà inscrit ? <a href="connexion_recruteur.php" class="text-decoration-none text-primary">Connectez-vous</a></p>
                        </div>        
                    </form>
                </div>
            </div>
