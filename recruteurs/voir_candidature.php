...
// Récupérer les candidatures avec info de base des candidats
$stmt = $bdd->prepare("SELECT c.id_candidature, c.statut, can.nom, can.prenom, can.email, can.id_candidat
                       FROM candidatures c
...
<head>
    ...
    <style>
        ...
        .card { border-radius: 16px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin-top: 80px; }
        .table th, .table td { vertical-align: middle; }
        .btn-sm { padding: 0.25rem 0.6rem; }
        h3.title { font-weight: 600; color: #2c3e50; }
    </style>
</head>
<body>
                    ...
                    <table class="table table-hover align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="profil_candidat.php?id_candidat=<?= $c['id_candidat'] ?>" class="btn btn-outline-info btn-sm">
